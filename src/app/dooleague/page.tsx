...
export const metadata: Metadata = { title: "Doo League" };

export default function DooLeaguePage() {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-4 py-20">
      ...
      <h1 className="font-heading font-black text-4xl sm:text-5xl uppercase tracking-widest text-ndl-text mb-2">
        <span className="text-ndl-accent">Doo</span> League
      </h1>
      <p className="text-ndl-muted text-base mb-6">dooleague.com — Coming soon.</p>
      <Link
        href="/"
