...
export const metadata: Metadata = { title: "Adam Swartzfager Hits Back-to-Back Threes — A Dooramp First — NDL Dooramp" };

export default function AdamSwartzfagerBackToBackThreesPage() {
  return (
    <ArticleLayout
    ...
    >
      <p>
        ...
        outlast the final score. In the 4th quarter, captain Adam Swartzfager drilled two three-pointers in a
      ...
      <p>
        ...
        never been done before Swartzfager did it in the 4th. It capped an 11-point night for him, as he
      ...
      <p>
        The back-to-back makes were also part of a rare three-point outburst for Swartzfager across his two
      ...
      <p>
        ...
        league still writing its early history, Swartzfager now owns a distinction no one else can claim.
      </p>
    </ArticleLayout>
  );
}
