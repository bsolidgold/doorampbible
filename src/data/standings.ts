export interface Team {
  ...
  elo: string;
  logo?: string;
  logoSize?: number;    // override display size in px, defaults to 56
  logoPadding?: number; // extra padding inside container to visually shrink logo
}
...
export const standings: Team[] = [
  ...
  { name: "Freaky Fredholers", wins: 0, losses: 0, elo: "---", logo: "/images/teams/freaky-fredholers.png", logoPadding: 16 },
